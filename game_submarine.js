...
//			alert(player);
//			alert([state.game_over,player=='player1']);
...
//	if (new_state==false) new_state=state;
	...
	if(state.game_over) {
		if(state.chosens['player1'].x==null && state.chosens['player2'].x2==null ) {
			...
			score={player1: -1, player2: 1};
		} else if (new_state.chosens.player1.x==new_state.chosens.player2.x1 && new_state.chosens.player1.y==new_state.chosens.player2.y1) {
			score={player1: 1, player2: -1};
		} else if (new_state.chosens.player1.x==new_state.chosens.player2.x2 && new_state.chosens.player1.y==new_state.chosens.player2.y2) {
			score={player1: 1, player2: -1};
		}
	} else {
		if(state.chosens['player1'].x==null || state.chosens['player2'].x2==null ) {
